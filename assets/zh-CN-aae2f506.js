import{_ as c,p as e,f as d,h as o,M as t,q as l,S as n,P as s,aq as p}from"./vue-router-0bbd6486.js";const r={components:{}},h={class:"varlet-site-doc"},j=t("h1",null,"提示",-1),i=t("div",{class:"card"},[t("h3",null,"介绍"),t("p",null,"当元素点击或悬停时显示一个提示，通过控制弹出位置和偏移量改变提示的显示位置。")],-1),g={class:"card"},m=t("h3",null,"基本使用",-1),v=t("pre",{class:"hljs"},[t("code",null,[t("span",{class:"hljs-tag"},[s("<"),t("span",{class:"hljs-name"},"template"),s(">")]),s(`
