import{_ as e,p as r,f as p,h as o,M as a,q as l,S as n,aq as c,P as s}from"./vue-router-0bbd6486.js";const d={components:{}},h={class:"varlet-site-doc"},j=a("h1",null,"结果",-1),i=a("div",{class:"card"},[a("h3",null,"介绍"),a("p",null,"用于向用户展示结果。")],-1),g={class:"card"},u=a("h3",null,"基本使用",-1),m=a("pre",{class:"hljs"},[a("code",null,[a("span",{class:"hljs-tag"},[s("<"),a("span",{class:"hljs-name"},"template"),s(">")]),s(`
